const translations = {
    en: {
        ...
        hero_subtitle: "Discover cutting-edge apps powered by AI technology to enhance social life experience. We develop applications for businesses (B2B) and consumers (B2C).",
        ...
        app_nf_title: "Nu Frequencies",
        app_nf_desc: "A holistic wellness web app combining binaural beats and coherent breathing to enhance focus, relaxation, and sleep. Features customized frequencies for deep rest and mental clarity.",
        app_nf_feat1: "Binaural Beats",
        app_nf_feat2: "Coherent Breathing",
        app_nf_feat3: "Focus, Relax & Sleep",
        app_nf_btn: "Visit Website →",
        app_ml_title: "Moonlight",
        app_ml_desc: "Your personal moon phase guide. Track full and new moon cycles, optimize your planting, and harmonize your daily life.",
        app_ml_feat1: "Real-Time Phases & Illumination",
        app_ml_feat2: "Lunar Gardening Guide",
        app_ml_feat3: "Localized Seasonal Produce",
        app_ml_btn: "Visit Website →",
        ...
        form_topic_nufreq: "Nu Frequencies App",
        form_topic_moonlight: "Moonlight App",
    ...
    fr: {
        ...
        hero_subtitle: "Découvrez des applications de pointe propulsées par l'IA pour enrichir votre vie sociale. Nous développons des applications pour les entreprises (B2B) et à destination des particuliers (B2C).",
        ...
        app_nf_title: "Nu Frequencies",
        app_nf_desc: "Une web app de bien-être holistique combinant sons binauraux et cohérence cardiaque pour améliorer la concentration, la relaxation et le sommeil.",
        app_nf_feat1: "Sons Binauraux",
        app_nf_feat2: "Cohérence Cardiaque",
        app_nf_feat3: "Focus, Détente & Sommeil",
        app_nf_btn: "Visiter le Site →",
        app_ml_title: "Moonlight",
        app_ml_desc: "Votre guide personnel des phases lunaires. Suivez les cycles de pleine et nouvelle lune, optimisez vos plantations et harmonisez votre quotidien.",
        app_ml_feat1: "Phases & Illumination en Temps Réel",
        app_ml_feat2: "Guide Jardinage Lunaire",
        app_ml_feat3: "Fruits & Légumes de Saison Localisés",
        app_ml_btn: "Visiter le Site →",
        ...
        form_topic_nufreq: "App Nu Frequencies",
        form_topic_moonlight: "App Moonlight",
